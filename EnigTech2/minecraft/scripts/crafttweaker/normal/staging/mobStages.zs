...
//太古魔像
mods.MobStages.addStage("three", "embers:acient_golem");
mods.MobStages.addStage("four", "embers:acient_golem");
mods.MobStages.addStage("five", "embers:acient_golem");
mods.MobStages.addStage("six", "embers:acient_golem");
mods.MobStages.addStage("alpha", "embers:acient_golem");
mods.MobStages.addStage("beta", "embers:acient_golem");
mods.MobStages.toggleSpawner("embers:acient_golem", true);
