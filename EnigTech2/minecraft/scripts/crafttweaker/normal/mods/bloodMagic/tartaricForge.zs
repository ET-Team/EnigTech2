...
TartaricForge.addRecipe(<botania:rune:4>*2,[<naturesaura:birth_spirit>, <minecraft:egg>, <botania:rune>], 200,50);
TartaricForge.addRecipe(<botania:rune:5>*2,[<minecraft:melon>, <contenttweaker:dried_grass>, <botania:rune:1>], 200,50);
TartaricForge.addRecipe(<botania:rune:6>*2,[<naturesaura:gold_leaf>, <roots:wildewheet>, <botania:rune:3>], 200,50);
TartaricForge.addRecipe(<botania:rune:7>*2,[<minecraft:snow>, <toughasnails:ice_cube>, <botania:rune:2>], 200,50);
