...
//外部火焰加热器
mods.naturesaura.TreeRitual.addRecipe("furnace_heater", <naturesaura:ancient_sapling>, <naturesaura:furnace_heater>*4, 50,[<botania:specialflower>.withTag({type: "exoflame"}),<botania:rune:5>,<minecraft:magma>,<naturesaura:token_fear>,<bloodmagic:lava_crystal>,<naturesaura:infused_stone>,<naturesaura:infused_stone>,<naturesaura:infused_iron>] );
//荒古树苗
