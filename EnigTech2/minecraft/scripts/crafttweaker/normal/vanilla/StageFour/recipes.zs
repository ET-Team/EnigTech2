...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator"}),[[<ore:plateSteel>,<minecraft:furnace>,<ore:plateSteel>],[<actuallyadditions:item_crystal_empowered:3>,<extrautils2:machine>,<actuallyadditions:item_crystal_empowered:3>],[<ore:plateSteel>,<enderio:item_power_conduit>,<ore:plateSteel>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_lava"}),[[<ore:plateSteel>,<bloodmagic:lava_crystal>,<ore:plateSteel>],[<contenttweaker:magic_motor>,<extrautils2:machine>,<contenttweaker:magic_motor>],[<ore:plateSteel>,<enderio:item_power_conduit>,<ore:plateSteel>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_pink"}),[[<minecraft:wool:6>,<botania:dye:6>,<minecraft:wool:6>],[<minecraft:pink_glazed_terracotta>,<extrautils2:machine>,<minecraft:pink_glazed_terracotta>],[<minecraft:wool:6>,<enderio:item_power_conduit>,<minecraft:wool:6>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_redstone"}),[[<ore:plateSteel>,<actuallyadditions:block_crystal_empowered>,<ore:plateSteel>],[<enderio:item_alloy_ingot:3>,<extrautils2:machine>,<enderio:item_alloy_ingot:3>],[<ore:plateSteel>,<enderio:item_power_conduit>,<ore:plateSteel>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_slime"}),[[<toughasnails:jelled_slime>,<enderio:item_soul_vial:1>.withTag({entityId: "minecraft:slime"}),<toughasnails:jelled_slime>],[<deepmoblearning:pristine_matter_slime>,<extrautils2:machine>,<deepmoblearning:pristine_matter_slime>],[<toughasnails:jelled_slime>,<enderio:item_power_conduit>,<toughasnails:jelled_slime>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_culinary"}),[[<ore:plateSteel>,<harvestcraft:tunarawitem>,<ore:plateSteel>],[<harvestcraft:cuttingboarditem>,<extrautils2:machine>,<harvestcraft:skilletitem>],[<ore:plateSteel>,<harvestcraft:bakewareitem>,<ore:plateSteel>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_overclock"}),[[<ore:plateSteel>,<extrautils2:ingredients:6>,<ore:plateSteel>],[<appliedenergistics2:material:30>,<extrautils2:machine>,<appliedenergistics2:material:30>],[<ore:plateSteel>,<enderio:item_power_conduit:1>,<ore:plateSteel>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_potion"}),[[<ore:plateSteel>,<arcanearchives:radiant_amphora>.withTag({}),<ore:plateSteel>],[<botania:rune:8>,<extrautils2:machine>,<botania:rune:8>],[<ore:plateSteel>,<arcanearchives:shaped_quartz>,<ore:plateSteel>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_survival"}),[[<ore:plateIron>,<minecraft:furnace>,<ore:plateIron>],[<enderio:item_material:20>,<contenttweaker:bad_machine_core>,<enderio:item_material:20>],[<ore:plateIron>,<enderio:item_power_conduit>,<ore:plateIron>]]);
