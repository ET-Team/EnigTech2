...
//充能水晶种子成型
FluidToItem.transform(<environmentaltech:litherite_crystal>*2,<fluid:fluid_dragon_breathe>, [<contenttweaker:charged_lith_pfe_crystal_seed>], true);
FluidToItem.transform(<environmentaltech:erodium_crystal>*2,<fluid:fluid_dragon_breathe>, [<contenttweaker:charged_erod_pfe_crystal_seed>], true);
FluidToItem.transform(<environmentaltech:kyronite_crystal>*2,<fluid:fluid_dragon_breathe>, [<contenttweaker:charged_kyro_pfe_crystal_seed>], true);
FluidToItem.transform(<environmentaltech:pladium_crystal>*2,<fluid:fluid_dragon_breathe>, [<contenttweaker:charged_plad_pfe_crystal_seed>], true);
FluidToItem.transform(<environmentaltech:ionite_crystal>*2,<fluid:fluid_dragon_breathe>, [<contenttweaker:charged_inoi_pfe_crystal_seed>], true);
FluidToItem.transform(<environmentaltech:aethium_crystal>*2,<fluid:fluid_dragon_breathe>, [<contenttweaker:charged_aeth_pfe_crystal_seed>], true);
FluidToItem.transform(<environmentaltech:lonsdaleite_crystal>*2,<fluid:fluid_dragon_breathe>, [<contenttweaker:charged_lons_pfe_crystal_seed>], true);