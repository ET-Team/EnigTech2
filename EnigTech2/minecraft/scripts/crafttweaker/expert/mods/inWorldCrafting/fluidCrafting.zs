...
//液态龙息
mods.inworldcrafting.FluidToFluid.transform(<liquid:fluid_dragon_breathe>, <liquid:water>, [<minecraft:dragon_breath> * 3]);
//极寒之凛冰
...
//基岩粉->奥术源质
mods.inworldcrafting.FluidToItem.transform(<contenttweaker:arcane_essence>*18, <liquid:fluid_dragon_breathe>,[<enderio:item_material:20>], true);
//方镁矾
mods.inworldcrafting.FluidToItem.transform(<embers:blend_caminite>*3, <liquid:fluid_blend_caminite>,[<contenttweaker:arcane_essence>*2], true);
