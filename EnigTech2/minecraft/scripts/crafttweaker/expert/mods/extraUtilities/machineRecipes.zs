...
chlorinizer.addRecipe({acid : <liquid:fluid_hydrochloric_acid>*1000, silicon : <contenttweaker:dust_silicon>} , {guiwan : <liquid:fluid_silicon>*1000}, 10000, 200);
chlorinizer.addRecipe({acid : <liquid:fluid_hydrochloric_acid>*200, silicon : <contenttweaker:slice_monosilicon>} , {output : <contenttweaker:chlorinized_slice_monosilicon>}, 8000, 80);
...
fluid.addRecipe({input:<liquid:fluid_silicon>*1000},{output:<liquid:fluid_concentrated_silicon>*400}, 2000, 80);
fluid.addRecipe({input:<liquid:fluid_ethylene>*1000},{output:<liquid:fluid_concentrated_ethylene>*400}, 2000, 120);
fluid.addRecipe({input:<liquid:fluid_oil_gas>*2000},{output:<liquid:fluid_ethylene>*1200}, 2000, 160);
