...
//木麒麟
Pyre.addRecipe("pereskia", <roots:pereskia>*2, [<minecraft:beetroot>, <minecraft:reeds>, <roots:wildroot>, <minecraft:redstone>, <roots:petals>]);
//睡莲
Pyre.addRecipe("waterlily", <minecraft:waterlily>*2, [<minecraft:vine>, <minecraft:cactus>, <ore:treeLeaves>, <ore:treeLeaves>, <roots:wildroot>]);
//闪耀纤维
Pyre.addRecipe("gold_fiber", <naturesaura:gold_fiber>*2, [<naturesaura:aura_bottle>.withTag({stored_type: "naturesaura:overworld"}), <survivalist:plant_fibres>, <twilightforest:torchberries>, <silentgems:craftingmaterial:1>, <contenttweaker:arcane_essence>]);
//白雏菊
