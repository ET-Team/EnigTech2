...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_silicon_fluid", machineName, 60)
...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_chlorinized_silicon", machineName, 24)
...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_rod_monocrystal_silicon", machineName, 80)
...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_multicrystal_silicon", machineName, 180)
...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_productgem", machineName, 180)
	.addFluidInput(<liquid:astralsorcery.liquidstarlight>*200)
...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_slice_monosilicon", machineName, 12)
...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_dark_gaiya_crystal", machineName, 180)
	.addFluidInput(<liquid:water>*100)
...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_baked_stable_potato", machineName, 160)
