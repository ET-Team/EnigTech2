...
recipes.addShaped(<environmentaltech:solar_cell_ionite>,[[<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>],[<contenttweaker:material_part:61>,<nuclearcraft:part:10>,<contenttweaker:material_part:61>],[<mekanism:controlcircuit:3>,<environmentaltech:ionite_crystal>,<mekanism:controlcircuit:3>]]);
recipes.addShaped(<environmentaltech:solar_cell_aethium>,[[<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>,<environmentaltech:photovoltaic_cell>],[<environmentaltech:aethium_crystal>,<environmentaltech:solar_cell_ionite>,<environmentaltech:aethium_crystal>],[<contenttweaker:material_part:61>,<environmentaltech:aethium_crystal>,<contenttweaker:material_part:61>]]);

mods.extendedcrafting.TableCrafting.addShaped(0, <extrautils2:rainbowgenerator>, [
	[<ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <contenttweaker:entropy>, <contenttweaker:entropy>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <extrautils2:machine>.withTag({Type: "extrautils2:generator_death"}), <extrautils2:machine>.withTag({Type: "extrautils2:generator_lava"}), <contenttweaker:entropy>, <contenttweaker:entropy>, <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <contenttweaker:entropy>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_pink"}), <extrautils2:opinium:4>, <ore:ingotCalifornium250>, <extrautils2:opinium:4>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_pink"}), <contenttweaker:entropy>, <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_redstone"}), <extrautils2:opinium:4>, <extrautils2:opinium:4>, <ore:ingotCalifornium250>, <extrautils2:opinium:4>, <extrautils2:opinium:4>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_slime"}), <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_culinary"}), <ore:ingotCalifornium250>, <ore:ingotCalifornium250>, <ore:ingotCalifornium250>, <ore:ingotCalifornium250>, <ore:ingotCalifornium250>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_overclock"}), <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_potion"}), <extrautils2:opinium:4>, <extrautils2:opinium:4>, <ore:ingotCalifornium250>, <extrautils2:opinium:4>, <extrautils2:opinium:4>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_ender"}), <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <contenttweaker:entropy>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_ice"}), <extrautils2:opinium:4>, <ore:ingotCalifornium250>, <extrautils2:opinium:4>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_enchant"}), <contenttweaker:entropy>, <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <contenttweaker:entropy>, <contenttweaker:entropy>, <extrautils2:machine>.withTag({Type: "extrautils2:generator_tnt"}), <extrautils2:machine>.withTag({Type: "extrautils2:generator_survival"}), <extrautils2:machine>.withTag({Type: "extrautils2:generator_netherstar"}), <contenttweaker:entropy>, <contenttweaker:entropy>, <ore:plateVoidMetal>], 
	[<ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>, <ore:plateVoidMetal>]
]);
