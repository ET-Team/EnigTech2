...
recipes.addShaped(<contenttweaker:fire_resist_mixture> * 5, [[<minecraft:clay_ball>, <minecraft:sand>, <ore:slimeball>],[<minecraft:sand>, <botania:specialflower>.withTag({type: "clayconia"}).reuse(), <minecraft:sand>], [<ore:slimeball>, <minecraft:sand>, <minecraft:clay_ball>]]);
