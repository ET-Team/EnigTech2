...
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_draconic_core", machineName, 500)
    ...
    .build();
//滞枢机械核心
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_zhishu_machine_core", machineName, 500)
    .addEnergyPerTickInput(1000)
    .addFluidInput(<liquid:fluid_lubricant>*100)
    ...
    .build();
//聚合核心
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_fusion_crafting_core", machineName, 500)
    .addEnergyPerTickInput(1000)
    ...
    .build();
//注入装置
mods.modularmachinery.RecipeBuilder.newBuilder(machineName + "_crafting_injector", machineName, 500)
    .addEnergyPerTickInput(1000)
    .addFluidInput(<liquid:fluid_dragon_breathe>*2000)
