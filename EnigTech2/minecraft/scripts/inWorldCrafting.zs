...
mods.inworldcrafting.FluidToFluid.transform(<liquid:fluid_hydrochloric_acid>, <liquid:sulfuric_acid>, <ore:itemSalt>);
...
mods.inworldcrafting.FluidToItem.transform(<contenttweaker:arcane_essence>*8, <liquid:fluid_dragon_breathe>,<enderio:item_material:20>, true);